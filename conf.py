...
BLOG_AUTHOR = "வணங்காமுடி"  # (translatable)
BLOG_TITLE = "செய்யறிவு"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://vanangamudi.github.io/ai-tamil/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pages.gitlab.io/nikola/"
BLOG_EMAIL = "selva.developer@gmail.com"
BLOG_DESCRIPTION = "செய்யறிவு தமிழில்"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "selvakumar.v2.x"
